...
init:
  ansible-playbook ansible/site.yml --limit vm_host
...
print-server:
  ...
  ansible-playbook ansible/site.yml --limit print_server
...
tailscale:
  ...
  ansible-playbook ansible/site.yml --limit tailscale
...
paperless:
  ...
  ansible-playbook ansible/site.yml --limit paperless
